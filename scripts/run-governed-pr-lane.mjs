...
export function buildLanePrBody({
  ...
  const intent = lane === "docs-pr"
    ? "This draft PR was opened by the `automaton` docs-pr lane to make one bounded explanation/docs improvement."
    : "This draft PR was opened by the `automaton` fix-pr lane to make one bounded bugfix in one repo surface.";
  const lines = [
    "## Summary",
    "",
    intent,
